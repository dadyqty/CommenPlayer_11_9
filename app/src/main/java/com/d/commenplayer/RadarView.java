...
public class RadarView extends FrameLayout {
    ...
    private void initPaint() {
        ...
        //随机生成的点，模拟雷达扫描结果
        point_x = getrandomarray(35, 0);
        point_y = getrandomarray(35, 0);
    }
    ...
    public int[] getrandomarray(int max,int min){
    ...
    protected void onDraw(Canvas canvas) {
        // TODO Auto-generated method stub
        canvas.drawCircle(viewSize / 2, viewSize / 2, 21, mPaintCircle);
        canvas.drawCircle(viewSize / 2, viewSize / 2, 15, mPaintLine);
        canvas.drawCircle(viewSize / 2, viewSize / 2, 7, mPaintLine);
        canvas.drawCircle(viewSize / 2, viewSize / 2, 21, mPaintLine);
        //绘制两条十字线
        ...
        canvas.drawCircle(viewSize / 2, viewSize / 2, 21, mPaintSector);
        super.onDraw(canvas);
    }
